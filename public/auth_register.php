...
<head>
    ...
    <link rel="stylesheet" href="../bootstrap-co../bootstrap-config/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="../bootstrap-co../bootstrap-config/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.php" class="app-brand-link gap-2">
                                <img src="schoollogo.png" alt="" class="w-px-100 h-px-100 rounded-circle" />
                            </a>
                        </div>
                        <!-- /Logo -->
                        <form action="../private/php_actions/auth_login_action.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <button class="btn btn-primary d-grid w-100" name="auth_register">Sign up</button>
                        </form>
